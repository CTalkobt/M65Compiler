...
BASIC_OBJECTS = $(OBJ_DIR)/basic45_main.o $(OBJ_DIR)/BasicTokenizer.o $(OBJ_DIR)/PETSCIIEncoder.o $(OBJ_DIR)/BasicEmitter.o $(OBJ_DIR)/BasicPreprocessor.o $(OBJ_DIR)/BasicDocGenerator.o $(OBJ_DIR)/BasicValidator.o $(OBJ_DIR)/LabelBasedSourceParser.o $(OBJ_DIR)/SymbolExpressionEvaluator.o $(OBJ_DIR)/BasicMinifier.o $(OBJ_DIR)/BasicTooling.o $(OBJ_DIR)/BasicCharacterMap.o $(OBJ_DIR)/BasicDocumentationGenerator.o $(OBJ_DIR)/BasicStructures.o $(OBJ_DIR)/BasicArchiveSupport.o
