...
# Common objects
COMMON_SOURCES = $(SRC_DIR)/Lexer.cpp $(SRC_DIR)/Parser.cpp $(SRC_DIR)/AST.cpp $(SRC_DIR)/TypeInfo.cpp $(SRC_DIR)/M65Emitter.cpp $(SRC_DIR)/Preprocessor.cpp $(SRC_DIR)/ConstantFolder.cpp $(SRC_DIR)/LoopOptimizer.cpp $(SRC_DIR)/LoopIdiomRegistry.cpp $(SRC_DIR)/AddressTemplateDetector.cpp $(SRC_DIR)/AddressTemplates.cpp $(SRC_DIR)/CodeGenerator.cpp $(SRC_DIR)/LoopInterchange.cpp $(SRC_DIR)/FunctionAnalyzer.cpp $(SRC_DIR)/OptimizationSelector.cpp $(SRC_DIR)/InlineSelector.cpp $(SRC_DIR)/CallGraphAnalyzer.cpp $(SRC_DIR)/DevirtualizationDetector.cpp $(SRC_DIR)/CoOptimizationSelector.cpp $(SRC_DIR)/DevirtualizationHints.cpp $(SRC_DIR)/CoOptimizationApplier.cpp $(SRC_DIR)/OptimizationCatalog.cpp $(SRC_DIR)/OptimizationController.cpp $(SRC_DIR)/AssemblerOpcodeDatabase.cpp $(SRC_DIR)/O45Reader.cpp $(SRC_DIR)/O45Writer.cpp $(SRC_DIR)/O45IRSerializer.cpp $(SRC_DIR)/O45Emitter.cpp $(SRC_DIR)/TypeSystem.cpp $(SRC_DIR)/ScopeManager.cpp $(SRC_DIR)/ConfigLoader.cpp $(SRC_DIR)/GlobalFunctionDatabase.cpp $(SRC_DIR)/CallPatternAnalyzer.cpp $(SRC_DIR)/IPOAnalyzer.cpp $(SRC_DIR)/IPOProfiler.cpp $(SRC_DIR)/SpecializationCodeGenerator.cpp $(SRC_DIR)/SpecializationOptimizer.cpp $(SRC_DIR)/IRSpecializationGenerator.cpp $(SRC_DIR)/StructFieldStriper.cpp $(SRC_DIR)/FieldStripedOffsetCalc.cpp $(SRC_DIR)/AddressSpaceValidator.cpp $(SRC_DIR)/GlobalPointerFieldDatabase.cpp $(SRC_DIR)/InterTUPatternDetector.cpp $(SRC_DIR)/FieldCachingAnalyzer.cpp $(SRC_DIR)/Phase96_5LinkerIntegration.cpp $(SRC_DIR)/Phase98FarAddressSupport.cpp $(SRC_DIR)/Phase98CodeGenIntegration.cpp $(SRC_DIR)/Phase99CrossModuleDatabase.cpp $(SRC_DIR)/Phase99BankAssignmentEngine.cpp $(SRC_DIR)/Phase99LinkerIntegration.cpp $(SRC_DIR)/Phase99BankOptimizer.cpp $(SRC_DIR)/Phase99CodeGenAdapter.cpp $(SRC_DIR)/Phase100HintCollector.cpp $(SRC_DIR)/Phase100ConstraintResolver.cpp $(SRC_DIR)/Phase100Coordinator.cpp $(SRC_DIR)/Phase100DependencyAnalyzer.cpp $(SRC_DIR)/Phase100CodeGenerator.cpp $(SRC_DIR)/Phase100Validator.cpp $(SRC_DIR)/Phase101Profiler.cpp $(SRC_DIR)/Phase101HotSpotDetector.cpp $(SRC_DIR)/Phase101ComparativeAnalyzer.cpp $(SRC_DIR)/Phase102PatternAnalyzer.cpp $(SRC_DIR)/Phase102AdaptiveSelector.cpp $(SRC_DIR)/Phase103CrossModuleEnhancer.cpp $(SRC_DIR)/Phase103DependencyTracker.cpp $(SRC_DIR)/Phase104BenchmarkSuite.cpp $(SRC_DIR)/Phase105CompilerIntegration.cpp $(SRC_DIR)/Phase105BenchmarkExecutor.cpp $(SRC_DIR)/Phase105MetricsCollector.cpp $(SRC_DIR)/Phase105ComparativeAnalyzer.cpp $(SRC_DIR)/Phase105ReportGenerator.cpp $(SRC_DIR)/Phase106IterationManager.cpp $(SRC_DIR)/Phase106OptimizationLearner.cpp $(SRC_DIR)/Phase106FeedbackCoordinator.cpp $(SRC_DIR)/Phase107OnlineLearner.cpp $(SRC_DIR)/Phase107TuningHooks.cpp $(SRC_DIR)/Phase108SignalCollector.cpp $(SRC_DIR)/Phase108FrontendIntegrator.cpp $(SRC_DIR)/Phase108Integration.cpp $(SRC_DIR)/Phase108DecisionLogic.cpp $(SRC_DIR)/Phase109EffectivenessCollector.cpp $(SRC_DIR)/Phase109ProfileDatabase.cpp $(SRC_DIR)/Phase109ThresholdAdjuster.cpp $(SRC_DIR)/Phase109PatternAnalyzer.cpp $(SRC_DIR)/Phase109AdaptiveSelector.cpp $(SRC_DIR)/Phase109Integration.cpp $(SRC_DIR)/TemplateOptimizationPass.cpp $(SRC_DIR)/TemplateRegistry.cpp $(SRC_DIR)/TemplateOptimizationSystem.cpp $(SRC_DIR)/MathLibraryOptimization.cpp $(SRC_DIR)/ConditionalChainFusion.cpp $(SRC_DIR)/RegisterResidentLoops.cpp $(SRC_DIR)/PointerCachingOptimization.cpp $(SRC_DIR)/TableDrivenDispatch.cpp $(SRC_DIR)/BitManipulationReduction.cpp $(SRC_DIR)/DMAOperationTemplate.cpp $(SRC_DIR)/ZeroPagePressureRelief.cpp
COMMON_OBJECTS = $(OBJ_DIR)/Lexer.o $(OBJ_DIR)/Parser.o $(OBJ_DIR)/AST.o $(OBJ_DIR)/TypeInfo.o $(OBJ_DIR)/M65Emitter.o $(OBJ_DIR)/Preprocessor.o $(OBJ_DIR)/ConstantFolder.o $(OBJ_DIR)/LoopOptimizer.o $(OBJ_DIR)/LoopIdiomRegistry.o $(OBJ_DIR)/AddressTemplateDetector.o $(OBJ_DIR)/AddressTemplates.o $(OBJ_DIR)/CodeGenerator.o $(OBJ_DIR)/LoopInterchange.o $(OBJ_DIR)/FunctionAnalyzer.o $(OBJ_DIR)/OptimizationSelector.o $(OBJ_DIR)/InlineSelector.o $(OBJ_DIR)/CallGraphAnalyzer.o $(OBJ_DIR)/DevirtualizationDetector.o $(OBJ_DIR)/CoOptimizationSelector.o $(OBJ_DIR)/DevirtualizationHints.o $(OBJ_DIR)/CoOptimizationApplier.o $(OBJ_DIR)/OptimizationCatalog.o $(OBJ_DIR)/OptimizationController.o $(OBJ_DIR)/AssemblerOpcodeDatabase.o $(OBJ_DIR)/O45Reader.o $(OBJ_DIR)/O45Writer.o $(OBJ_DIR)/O45IRSerializer.o $(OBJ_DIR)/O45Emitter.o $(OBJ_DIR)/TypeSystem.o $(OBJ_DIR)/ScopeManager.o $(OBJ_DIR)/ConfigLoader.o $(OBJ_DIR)/GlobalFunctionDatabase.o $(OBJ_DIR)/CallPatternAnalyzer.o $(OBJ_DIR)/IPOAnalyzer.o $(OBJ_DIR)/IPOProfiler.o $(OBJ_DIR)/SpecializationCodeGenerator.o $(OBJ_DIR)/SpecializationOptimizer.o $(OBJ_DIR)/IRSpecializationGenerator.o $(OBJ_DIR)/StructFieldStriper.o $(OBJ_DIR)/FieldStripedOffsetCalc.o $(OBJ_DIR)/AddressSpaceValidator.o $(OBJ_DIR)/GlobalPointerFieldDatabase.o $(OBJ_DIR)/InterTUPatternDetector.o $(OBJ_DIR)/FieldCachingAnalyzer.o $(OBJ_DIR)/Phase96_5LinkerIntegration.o $(OBJ_DIR)/Phase98FarAddressSupport.o $(OBJ_DIR)/Phase98CodeGenIntegration.o $(OBJ_DIR)/Phase99CrossModuleDatabase.o $(OBJ_DIR)/Phase99BankAssignmentEngine.o $(OBJ_DIR)/Phase99LinkerIntegration.o $(OBJ_DIR)/Phase99BankOptimizer.o $(OBJ_DIR)/Phase99CodeGenAdapter.o $(OBJ_DIR)/Phase100HintCollector.o $(OBJ_DIR)/Phase100ConstraintResolver.o $(OBJ_DIR)/Phase100Coordinator.o $(OBJ_DIR)/Phase100DependencyAnalyzer.o $(OBJ_DIR)/Phase100CodeGenerator.o $(OBJ_DIR)/Phase100Validator.o $(OBJ_DIR)/Phase101Profiler.o $(OBJ_DIR)/Phase101HotSpotDetector.o $(OBJ_DIR)/Phase101ComparativeAnalyzer.o $(OBJ_DIR)/Phase102PatternAnalyzer.o $(OBJ_DIR)/Phase102AdaptiveSelector.o $(OBJ_DIR)/Phase103CrossModuleEnhancer.o $(OBJ_DIR)/Phase103DependencyTracker.o $(OBJ_DIR)/Phase104BenchmarkSuite.o $(OBJ_DIR)/Phase105CompilerIntegration.o $(OBJ_DIR)/Phase105BenchmarkExecutor.o $(OBJ_DIR)/Phase105MetricsCollector.o $(OBJ_DIR)/Phase105ComparativeAnalyzer.o $(OBJ_DIR)/Phase105ReportGenerator.o $(OBJ_DIR)/Phase106IterationManager.o $(OBJ_DIR)/Phase106OptimizationLearner.o $(OBJ_DIR)/Phase106FeedbackCoordinator.o $(OBJ_DIR)/Phase107OnlineLearner.o $(OBJ_DIR)/Phase107TuningHooks.o $(OBJ_DIR)/Phase108SignalCollector.o $(OBJ_DIR)/Phase108FrontendIntegrator.o $(OBJ_DIR)/Phase108Integration.o $(OBJ_DIR)/Phase108DecisionLogic.o $(OBJ_DIR)/Phase109EffectivenessCollector.o $(OBJ_DIR)/Phase109ProfileDatabase.o $(OBJ_DIR)/Phase109ThresholdAdjuster.o $(OBJ_DIR)/Phase109PatternAnalyzer.o $(OBJ_DIR)/Phase109AdaptiveSelector.o $(OBJ_DIR)/Phase109Integration.o $(OBJ_DIR)/TemplateOptimizationPass.o $(OBJ_DIR)/TemplateRegistry.o $(OBJ_DIR)/TemplateOptimizationSystem.o $(OBJ_DIR)/MathLibraryOptimization.o $(OBJ_DIR)/ConditionalChainFusion.o $(OBJ_DIR)/RegisterResidentLoops.o $(OBJ_DIR)/PointerCachingOptimization.o $(OBJ_DIR)/TableDrivenDispatch.o $(OBJ_DIR)/BitManipulationReduction.o $(OBJ_DIR)/DMAOperationTemplate.o $(OBJ_DIR)/ZeroPagePressureRelief.o
