...
COMMON_OBJECTS = $(OBJ_DIR)/Lexer.o $(OBJ_DIR)/Parser.o $(OBJ_DIR)/AST.o $(OBJ_DIR)/TypeInfo.o $(OBJ_DIR)/M65Emitter.o $(OBJ_DIR)/Preprocessor.o $(OBJ_DIR)/ConstantFolder.o $(OBJ_DIR)/LoopOptimizer.o $(OBJ_DIR)/LoopInterchange.o $(OBJ_DIR)/FunctionAnalyzer.o $(OBJ_DIR)/OptimizationSelector.o $(OBJ_DIR)/InlineSelector.o $(OBJ_DIR)/CallGraphAnalyzer.o $(OBJ_DIR)/DevirtualizationDetector.o $(OBJ_DIR)/CoOptimizationSelector.o $(OBJ_DIR)/DevirtualizationHints.o $(OBJ_DIR)/CoOptimizationApplier.o $(OBJ_DIR)/AssemblerOpcodeDatabase.o $(OBJ_DIR)/O45Reader.o $(OBJ_DIR)/O45Writer.o $(OBJ_DIR)/O45IRSerializer.o $(OBJ_DIR)/O45Emitter.o $(OBJ_DIR)/TypeSystem.o $(OBJ_DIR)/ScopeManager.o $(OBJ_DIR)/ConfigLoader.o
