...
; Phase 51: zero-alloc leaf (all parameters constant)
    .var _fp = 0
    .loc "src/test-resources/test_constant_folding.c", 1
    .local @_l_a = 0
    .local @_l_b = 2
    .local @_l_c = 4
    .local @_l_d = 6
...
@entry:
    .loc "src/test-resources/test_constant_folding.c", 3
    lda #3
    sta _main__local_0
    lda #0
    sta _main__local_0+1
    .loc "src/test-resources/test_constant_folding.c", 4
    lda #5
    sta _main__local_2
    lda #0
    sta _main__local_2+1
    .loc "src/test-resources/test_constant_folding.c", 5
    lda #12
    sta _main__local_4
    lda #0
    sta _main__local_4+1
    .loc "src/test-resources/test_constant_folding.c", 6
    lda #10
    sta _main__local_6
    lda #0
    sta _main__local_6+1
    .loc "src/test-resources/test_constant_folding.c", 9
    lda #15
    sta _main__local_8
    lda #0
    sta _main__local_8+1
    .loc "src/test-resources/test_constant_folding.c", 12
    lda #16
    sta _main__local_10
    lda #0
    sta _main__local_10+1
    .loc "src/test-resources/test_constant_folding.c", 13
    lda #32
    sta _main__local_12
    lda #0
    sta _main__local_12+1
    .loc "src/test-resources/test_constant_folding.c", 14
    lda #15
    sta _main__local_14
    lda #0
    sta _main__local_14+1
    .loc "src/test-resources/test_constant_folding.c", 15
    lda #255
    sta _main__local_16
    lda #0
    sta _main__local_16+1
    .loc "src/test-resources/test_constant_folding.c", 16
    lda #85
    sta _main__local_18
    lda #0
    sta _main__local_18+1
    .loc "src/test-resources/test_constant_folding.c", 19
    lda #1
    sta _main__local_20
    lda #0
    sta _main__local_20+1
    .loc "src/test-resources/test_constant_folding.c", 20
    lda #0
    sta _main__local_22
    sta _main__local_22+1
    .loc "src/test-resources/test_constant_folding.c", 21
    lda #1
    sta _main__local_24
    lda #0
    sta _main__local_24+1
    .loc "src/test-resources/test_constant_folding.c", 22
    lda #0
    sta _main__local_26
    sta _main__local_26+1
    .loc "src/test-resources/test_constant_folding.c", 25
    lda #0
    sta _main__local_28
    sta _main__local_28+1
    .loc "src/test-resources/test_constant_folding.c", 26
    lda #1
    sta _main__local_30
    lda #0
    sta _main__local_30+1
    .loc "src/test-resources/test_constant_folding.c", 34
    lda #42
    sta _main__local_2
    lda #0
    sta _main__local_2+1
    .loc "src/test-resources/test_constant_folding.c", 47
    lda _main__local_2
