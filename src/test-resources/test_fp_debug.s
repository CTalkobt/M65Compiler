...
; Phase 51: zero-alloc leaf (all parameters constant)
    .var _fp = 0
    .loc "test_fp_debug.c", 5
    .local @_l_p = 6
    .local @_l_x = 0
    .local @_l_y = 2
    .local @_l_z = 4
; .debug_var: __main @_l_p offset=6 size=2 type=ptr scope=local
...
@entry:
    .loc "test_fp_debug.c", 6
    lda #10
    sta _main__local_0
    lda #0
    sta _main__local_0+1
    .loc "test_fp_debug.c", 7
    .loc "test_fp_debug.c", 8
    lda #30
    sta _main__local_4
    lda #0
    sta _main__local_4+1
    .loc "test_fp_debug.c", 9
    leax.local 0
    sta $20
    stx $21
    lda $20
