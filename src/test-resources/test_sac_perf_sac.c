// SAC Performance Benchmark - SAC version
// Compile WITH -fstaticalloc: cc45 test_sac_perf_sac.c -fstaticalloc -o sac.prg
// Compare binary size and cycles with non-SAC version

// IDENTICAL to baseline, just compiled with different flag
// This allows direct comparison of SAC vs non-SAC code generation
