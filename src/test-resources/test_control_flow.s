...
@entry:
    .loc "test_control_flow.c", 2
    lda #0
    sta _main__local_0
    sta _main__local_0+1
    .loc "test_control_flow.c", 3
    lda #0
    sta _main__local_2
    sta _main__local_2+1
@while_cond0:
    .loc "test_control_flow.c", 4
    lda _main__local_0
...
@while_body1:
    ...
    .loc "test_control_flow.c", 6
    inc.16f __vr0
    bra @while_cond0
@while_end2:
    .loc "test_control_flow.c", 9
    lda _main__local_2
    ldx _main__local_2+1
    cmp.16 .AX, #45
    beq @if_then3
    bra @if_else4
@if_then3:
    .loc "test_control_flow.c", 10
    lda #1
    ldx #0
    bra @__return
    bra @if_end5
@if_else4:
    .loc "test_control_flow.c", 12
    lda #0
    ldx #0
    bra @__return
@if_end5:
