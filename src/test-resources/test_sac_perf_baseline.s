...
; SAC inline storage: 4 bytes
    ...
    .sac
    .var _fp = 0
    .loc "test_sac_perf_baseline.c", 6
    .var @_p_a = 2
    .var @_p_b = 4
...
@entry:
    .loc "test_sac_perf_baseline.c", 7
...
; SAC inline storage: 12 bytes
    ...
    .sac
    .var _fp = 0
    .loc "test_sac_perf_baseline.c", 11
    .local @_l_result = 10
    .local @_l_temp1 = 6
    .local @_l_temp2 = 8
...
@entry:
    .loc "test_sac_perf_baseline.c", 12
    ...
    .loc "test_sac_perf_baseline.c", 13
    ...
    .loc "test_sac_perf_baseline.c", 14
    ...
    .loc "test_sac_perf_baseline.c", 15
...
; SAC inline storage: 12 bytes
    ...
    .sac
    .var _fp = 0
    .loc "test_sac_perf_baseline.c", 19
    .local @_l_sum1 = 8
    .local @_l_sum2 = 10
...
@entry:
    .loc "test_sac_perf_baseline.c", 20
...
@inline_end0:
    ...
    .loc "test_sac_perf_baseline.c", 21
...
@inline_end2:
    ...
    .loc "test_sac_perf_baseline.c", 22
...
; SAC inline storage: 6 bytes
    ...
    .sac
    .var _fp = 0
    .loc "test_sac_perf_baseline.c", 26
    .local @_l_i = 4
    .local @_l_total = 2
...
@while_cond4_ph:
    ...
    stx $23
@while_cond4:
    .loc "test_sac_perf_baseline.c", 29
    ...
    bra @while_end6
@while_body5:
    .loc "test_sac_perf_baseline.c", 30
...
@inline_end9:
    ...
    bra @while_cond4
@while_end6:
    .loc "test_sac_perf_baseline.c", 33
    lda _sum_via_calls__local_1
    ldx _sum_via_calls__local_1+1
@__return:
    rts
...
; SAC inline storage: 10 bytes
    ...
    .sac
    .var _fp = 0
    .loc "test_sac_perf_baseline.c", 37
    .var @_p_a = 2
    .var @_p_b = 4
    .var @_p_c = 6
    .var @_p_d = 8
...
@entry:
    .loc "test_sac_perf_baseline.c", 38
...
; Phase 51: zero-alloc leaf (all parameters constant)
    .var _fp = 0
    .loc "test_sac_perf_baseline.c", 41
    .local @_l_i = 20
    .local @_l_r1 = 0
    .local @_l_r2 = 2
    .local @_l_r3 = 10
...
@entry:
    .loc "test_sac_perf_baseline.c", 43
    .loc "test_sac_perf_baseline.c", 7
@inline_end11:
    .loc "test_sac_perf_baseline.c", 43
    .loc "test_sac_perf_baseline.c", 44
    .loc "test_sac_perf_baseline.c", 12
    .loc "test_sac_perf_baseline.c", 13
    .loc "test_sac_perf_baseline.c", 14
    .loc "test_sac_perf_baseline.c", 15
@inline_end13:
    .loc "test_sac_perf_baseline.c", 44
    .loc "test_sac_perf_baseline.c", 45
    .loc "test_sac_perf_baseline.c", 20
    .loc "test_sac_perf_baseline.c", 7
@inline_end16:
    .loc "test_sac_perf_baseline.c", 20
...
@inline_end15:
    .loc "test_sac_perf_baseline.c", 45
    .loc "test_sac_perf_baseline.c", 46
    lda #5
    ldx #0
    sta $20
    stx $21
...
@inline_end21:
    .loc "test_sac_perf_baseline.c", 46
    .loc "test_sac_perf_baseline.c", 47
    .loc "test_sac_perf_baseline.c", 38
@inline_end30:
    .loc "test_sac_perf_baseline.c", 47
    .loc "test_sac_perf_baseline.c", 50
    brk
@__return:
    rts
    .func_flags stack_call, static_alloc, leaf
