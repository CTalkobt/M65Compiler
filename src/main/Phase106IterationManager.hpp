...
class Phase106IterationManager {
public:
    Phase106IterationManager(phase105::Phase105BenchmarkExecutor& executor,
                            phase105::Phase105ComparativeAnalyzer& analyzer)
...
private:
    phase105::Phase105BenchmarkExecutor& executor_;
    phase105::Phase105ComparativeAnalyzer& analyzer_;
