...
void Phase104BenchmarkSuite::defineBenchmarks() {
...
void Phase104BenchmarkSuite::createLoopBenchmarks() {
...
void Phase104BenchmarkSuite::createStructBenchmarks() {
    BenchmarkProgram bench;
...
void Phase104BenchmarkSuite::createMemoryBenchmarks() {
    BenchmarkProgram bench;
...
void Phase104BenchmarkSuite::createMixedBenchmarks() {
    BenchmarkProgram bench;
...
void Phase104BenchmarkSuite::addBenchmark(const BenchmarkProgram& program) {
    benchmarks_.push_back(program);
}

const BenchmarkProgram* Phase104BenchmarkSuite::findBenchmark(
...
std::vector<BenchmarkProgram> Phase104BenchmarkSuite::getBenchmarksByCategory(
...
BenchmarkResult Phase104BenchmarkSuite::runBenchmark(
...
std::vector<BenchmarkResult> Phase104BenchmarkSuite::runAllBenchmarks() {
...
std::vector<BenchmarkResult> Phase104BenchmarkSuite::runBenchmarksByCategory(
...
std::string Phase104BenchmarkSuite::generateBenchmarkReport(
...
double Phase104BenchmarkSuite::getAverageSizeReduction() const {
...
double Phase104BenchmarkSuite::getAverageSpeedup() const {
    if (results_.empty()) return 0.0;
...
BenchmarkResult Phase104BenchmarkSuite::simulateBenchmarkRun(
    const BenchmarkProgram& program) {
    BenchmarkResult result;
    result.programName = program.name;
...
std::string Phase104BenchmarkSuite::formatResultRow(
