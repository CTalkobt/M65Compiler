...
class Phase107TuningHooks;

// Frontend integrator: wires Phase 107 hooks into compiler pipeline
class Phase108FrontendIntegrator {
public:
    Phase108FrontendIntegrator();
    ~Phase108FrontendIntegrator();
    ...
    // Configuration
    void setLearnerRef(Phase107OnlineLearner* learner) { learner_ = learner; }
    void setHooksRef(Phase107TuningHooks* hooks) { hooks_ = hooks; }
...
private:
    ...
    Phase107OnlineLearner* learner_;       // Not owned
    Phase107TuningHooks* hooks_;           // Not owned
    bool hooksEnabled_;
    bool verbose_;
    double budgetMs_;
