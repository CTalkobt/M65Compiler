...
#include "LinkTimeOptimizationCoordinator.hpp"
#include <string>
#include <vector>
#include <map>
#include <memory>
...
class LinkTimeOptimizationCodeGenerator {
public:
    explicit LinkTimeOptimizationCodeGenerator(const LinkTimeCoordinator& coordinator)
