...
#include "Phase98FarAddressSupport.hpp"
...
// Integration layer between CodeGenerator and Phase98FarAddressSupport
class Phase98CodeGenIntegration {
public:
    explicit Phase98CodeGenIntegration(M65Emitter& emitter);
