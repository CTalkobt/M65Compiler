...
class CrossModuleEnhancer {
public:
    explicit CrossModuleEnhancer(
        const phase102::PatternBasedOptimizationSelector& selector)
        : selector_(selector) {}
...
private:
    const phase102::PatternBasedOptimizationSelector& selector_;
