...
public:
    BenchmarkExecutor(BenchmarkCompilerIntegration& compiler,
                              phase102::PatternBasedOptimizationSelector& selector)
...
private:
    BenchmarkCompilerIntegration& compiler_;
    phase102::PatternBasedOptimizationSelector& adaptiveSelector_;
