...
Phase109EffectivenessCollector::Phase109EffectivenessCollector()
    : totalOptimizationApplications_(0) {
}

Phase109EffectivenessCollector::~Phase109EffectivenessCollector() = default;

void Phase109EffectivenessCollector::startSession(
...
void Phase109EffectivenessCollector::recordSignalAndDecision(
...
void Phase109EffectivenessCollector::recordOptimizationApplication(
...
void Phase109EffectivenessCollector::finializeCompilation(
...
OptimizationEffectiveness Phase109EffectivenessCollector::getEffectiveness(
...
Phase109EffectivenessCollector::getAllEffectiveness() const {
...
OptimizationEffectiveness Phase109EffectivenessCollector::computeEffectiveness(
    const std::string& optimizationName) const {
...
void Phase109EffectivenessCollector::saveToDatabase(
...
void Phase109EffectivenessCollector::loadFromDatabase(
    const std::string& dbPath) {
...
std::string Phase109EffectivenessCollector::recordToJson(
...
CompilationRecord Phase109EffectivenessCollector::recordFromJson(
