...
namespace phase101 { class Phase101ComparativeAnalyzer; }
...
class Phase102PatternAnalyzer {
public:
    explicit Phase102PatternAnalyzer(
        const phase101::Phase101ComparativeAnalyzer& analyzer)
        : analyzer_(analyzer) {}
...
private:
    const phase101::Phase101ComparativeAnalyzer& analyzer_;
