...
class LearnerBasedOptimizationSelector {
public:
    ...
    void setPatternAnalyzer(
        const std::shared_ptr<OptimizationPatternAnalyzer>& analyzer) {
...
private:
    ...
    std::shared_ptr<OptimizationPatternAnalyzer> patternAnalyzer_;
