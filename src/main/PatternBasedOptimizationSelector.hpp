...
class PatternBasedOptimizationSelector {
public:
    explicit PatternBasedOptimizationSelector(
        const phase102::PatternRecognitionEngine& analyzer)
        : analyzer_(analyzer) {}
...
private:
    const phase102::PatternRecognitionEngine& analyzer_;
