...
BenchmarkReport BenchmarkReportGenerator::generateReport(
    ...
    std::vector<BenchmarkComparativeAnalyzer::BenchmarkBestStrategy> best;
    for (const auto& [benchName, benchResults] : byBench) {
        BenchmarkComparativeAnalyzer::BenchmarkBestStrategy b;
...
std::string BenchmarkReportGenerator::generateExecutiveSummary(
    const AggregateMetrics& metrics,
    const std::vector<StrategyComparison>& comparisons) {
...
std::string BenchmarkReportGenerator::generateBestPractices(
    const std::vector<BenchmarkComparativeAnalyzer::BenchmarkBestStrategy>& best) {
...
std::string BenchmarkReportGenerator::generateRecommendations(
...
bool BenchmarkReportGenerator::saveReport(const BenchmarkReport& report,
...
std::string BenchmarkReportGenerator::generateHTMLReport(
...
std::string BenchmarkReportGenerator::generateMarkdownReport(
    const BenchmarkReport& report) {
...
bool BenchmarkReportGenerator::exportMetricsCSV(
    const std::vector<ExecutionResult>& results,
...
std::string BenchmarkReportGenerator::getCurrentTimestamp() {
...
std::string BenchmarkReportGenerator::formatSection(const std::string& title,
...
std::string BenchmarkReportGenerator::generateMetricsTable(
    const AggregateMetrics& metrics) {
...
std::string BenchmarkReportGenerator::generateStrategyTable(
...
std::string BenchmarkReportGenerator::escapeHTML(const std::string& text) {
    std::stringstream ss;
    for (char c : text) {
        switch (c) {
            case '&': ss << "&amp;"; break;
