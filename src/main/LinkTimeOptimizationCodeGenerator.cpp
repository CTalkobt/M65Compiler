...
std::string LinkTimeOptimizationCodeGenerator::generateOptimizedCode(const CoordinationPlan& plan) {
...
std::string LinkTimeOptimizationCodeGenerator::applySpecializationCode(
...
std::string LinkTimeOptimizationCodeGenerator::applyCachingCode(
    const std::shared_ptr<OptimizationHint>& hint) {
    std::stringstream code;
...
std::string LinkTimeOptimizationCodeGenerator::applyBankHoistingCode(
    const std::shared_ptr<OptimizationHint>& hint) {
    std::stringstream code;
...
std::string LinkTimeOptimizationCodeGenerator::generateDispatchCode(
...
std::string LinkTimeOptimizationCodeGenerator::emitWithComments(
...
std::string LinkTimeOptimizationCodeGenerator::generateCacheCheckSequence(
    const std::shared_ptr<OptimizationHint>& hint) {
    std::stringstream code;
...
std::string LinkTimeOptimizationCodeGenerator::generateBankSetupSequence(
    const std::shared_ptr<OptimizationHint>& hint) {
    std::stringstream code;
...
std::string LinkTimeOptimizationCodeGenerator::formatDebugComment(
    const std::shared_ptr<OptimizationHint>& hint,
...
std::string LinkTimeOptimizationCodeGenerator::generateSpecializationSelector(
...
std::string LinkTimeOptimizationCodeGenerator::generateInlineCode(
    const std::shared_ptr<OptimizationHint>& hint) {
    std::stringstream code;
...
std::string LinkTimeOptimizationCodeGenerator::generateCallSiteAdapter(
    const std::shared_ptr<OptimizationHint>& hint) {
    std::stringstream code;
