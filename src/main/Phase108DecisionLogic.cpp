...
Phase108DecisionLogic::Phase108DecisionLogic()
    : learner_(nullptr),
      totalDecisions_(0),
      decisionsChanged_(0) {
}

Phase108DecisionLogic::~Phase108DecisionLogic() = default;

HookDecision Phase108DecisionLogic::decideOptimizationSelection(
...
HookDecision Phase108DecisionLogic::decideIROptimization(
    const CompilationSignal& signal,
    bool currentOptimizationState,
    double budgetMs) {
...
HookDecision Phase108DecisionLogic::decideInlining(
    const CompilationSignal& signal,
...
void Phase108DecisionLogic::applyOptimizationFlags(
...
bool Phase108DecisionLogic::consultLearnerForOptimization(
...
double Phase108DecisionLogic::estimateOptimizationBenefit(
    const CompilationSignal& signal) {
...
HookDecision Phase108DecisionLogic::makeConservativeDecision(
    const CompilationSignal& signal,
    double budgetMs) {
