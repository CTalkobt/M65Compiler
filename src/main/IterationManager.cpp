...
std::vector<IterationResult> IterationManager::runBenchmarkLoop(
...
IterationResult IterationManager::executeIteration(
    const std::vector<phase104::BenchmarkProgram>& benchmarks,
    int iterationNumber,
...
double IterationManager::computeImprovement(
...
bool IterationManager::detectConvergence(
...
std::vector<phase105::ExecutionStrategy> IterationManager::selectStrategiesForNextIteration(
...
std::string IterationManager::generateLoopReport(
    const std::vector<IterationResult>& results) {
...
std::string IterationManager::generateConvergenceAnalysis(
    const std::vector<IterationResult>& results) {
...
std::string IterationManager::formatIterationRow(
...
std::string IterationManager::formatConvergenceRow(
