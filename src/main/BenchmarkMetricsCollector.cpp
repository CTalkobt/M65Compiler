...
#include "BenchmarkMetricsCollector.hpp"
#include <algorithm>
#include <sstream>
#include <iomanip>
#include <numeric>
...
AggregateMetrics BenchmarkMetricsCollector::collectMetrics(
...
OptimizationMetrics BenchmarkMetricsCollector::computeOptimizationMetrics(
...
BenchmarkMetricsCollector::BenchmarkMetrics BenchmarkMetricsCollector::computeBenchmarkMetrics(
...
std::vector<BenchmarkMetricsCollector::OptimizationCorrelation>
BenchmarkMetricsCollector::analyzeOptimizationSynergy(
    const std::vector<ExecutionResult>& results) {
...
std::string BenchmarkMetricsCollector::generateMetricsReport(
...
double BenchmarkMetricsCollector::computeMedian(std::vector<double> values) {
...
std::string BenchmarkMetricsCollector::formatMetricsRow(
...
std::string BenchmarkMetricsCollector::formatCorrelationRow(
