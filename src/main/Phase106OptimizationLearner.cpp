...
void Phase106OptimizationLearner::learnFromResults(
...
void Phase106OptimizationLearner::extractPatternsFromIteration(
...
WorkloadCharacterization Phase106OptimizationLearner::classifyWorkload(
...
std::string Phase106OptimizationLearner::predictBestOptimization(
...
double Phase106OptimizationLearner::computePatternConfidence(
...
std::vector<Phase106OptimizationLearner::OptimizationHeuristic>
Phase106OptimizationLearner::extractHeuristics() {
...
std::string Phase106OptimizationLearner::generateLearningReport() {
...
void Phase106OptimizationLearner::updatePatternStatistics() {
...
std::string Phase106OptimizationLearner::formatPatternRow(
    const OptimizationPattern& pattern) {
