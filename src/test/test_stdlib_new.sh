...
EOF
# qsort, bsearch: blocked by #178 (global function pointer across linked objects)
# mktime, asctime: blocked by #179 (struct tm across linked objects)
echo "  SKIP: qsort (blocked by #178)"
echo "  SKIP: bsearch (blocked by #178)"
