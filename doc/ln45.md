...
| `ln45: warning: unused global symbol 'X' (defined in FILE.o45)` | A symbol was marked as `.global` (exported) but is not referenced by any other module in the program. This helps identify dead code. |
