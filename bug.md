...
**File:** `lib/stdlib/memset.s:32` (also `lib/stdlib_zp/memset.s:23`)
...
**File:** `lib/stdlib/memcpy.s:56-58`
...
**Files:** `IRCodeGen.cpp`, `AssemblerGenerator.cpp`, `AssemblerParser.cpp`, `memcpy.s`
...
3.  **DMA Fix/Removal**: Identified that `crt0.s` was triggering DMA using the wrong registers and before I/O enable. Replaced DMA-based ZP save/restore with simple assembly loops for maximum safety.
